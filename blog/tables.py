...
class BlogPostsListTable(tables.Table):
    ...
    publication_date = tables.Column(accessor='publication_date', verbose_name='Last Edited')
    ...
    class Meta:
        ...
        fields = ['title', 'description', 'author', 'publication_date']
        empty_text = 'No blog posts found...Why not create one?'
...
class BlogPostsListFilter(django_filters.FilterSet):
    ...
    def search_filter(self, queryset, name, value):
        return queryset.filter((Q(title__icontains=value) | Q(description__icontains=value) | Q(author__name__icontains=value)))
