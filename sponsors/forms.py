...
class SponsorForm(forms.ModelForm):
    ...
    other_diet = forms.CharField(max_length=255, required=False,
                                 help_text='If you selected "Others" above, please describe your dietary restrictions in this field.')

    company_logo = forms.ImageField(required=False,
                                    help_text="We would highly appreciate if you could upload your company's logo (preferably in .svg or .png format) in order to speed up the process of getting your company's logo onto our site.")
